...
We can see there are some roads used by commuters from these sites that are particularly busy. These include the A63 near Garforth and the A61 on the eastern edge of Leeds City Centre (circle these roads) (remove Sutton Grange Lane which is private)
...
```{r}
knitr::include_graphics("https://user-images.githubusercontent.com/52210872/73958112-50f03000-48ff-11ea-993d-a61558866bac.png")
```

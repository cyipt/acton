...
The result in the `applications_leeds` contain much rich information the planning application, under the following column headings:
...
```{r}
DT::datatable(applications_leeds[-c(1, 9)])
```
...
```{r}
allerton_bywater = applications_case_study[1, ]

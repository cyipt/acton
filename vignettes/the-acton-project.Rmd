...
piggyback::pb_upload("the-acton-project.docx")
...
Transport was the UK's largest and fastest growing source of carbon emissions before the Covid-19 pandemic [@departmentfortransport_decarbonising_2020], and these emissions must be tackled in order to meet the UK government's legally binding target of net zero carbon emissions by 2050 [@committeeonclimatechange_net_2019]. There are a raft of reasons to tackle car dependency, including overwhelming evidence of the health and social benefits of active travel [@goodman_scenarios_2019;@mueller_health_2018] and the harms caused by air pollution [@schraufnagel_air_2019], which may even include exacerbating the lethality of Covid-19 [@conticini_can_2020]. For all of these reasons it is vital that new housing developments are conducive to low-carbon lifestyles, which means low levels of car ownership and use, and high levels of walking and cycling for everyday trips.
...
New residential developments have tended to be located in places that lock residents into car dependent lifestyles [@transportfornewhomes_transport_2018], something that central government aims to tackle [@mhclg_planning_2020].

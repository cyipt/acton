...
The government's agressive and legally binding climate targets, plus overwhelming evidence of the health and social benefits of active travel, make it vital that new developments are conducive to low-carbon lifestyles.
...
This project aims to support the changes that are needed for healthy transport systems to become the norm, rather the exception, for new developments.

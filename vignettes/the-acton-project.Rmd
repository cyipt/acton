...
author: "<br><br><br><br><br><br><br><br><br>Joey Talbot, Robin Lovelace<br>(University of Leeds)<br>Martin Lucas-Smith, Simon Nuttall<br>(CycleStreets)<br>Andrew Speakman<br>(PlanIt)"
...
pagedown::chrome_print("file:///tmp/RtmpmD47bN/preview-7654589e7bac.dir/the-acton-project.html", output = "acton-report.pdf")
...
Available fields include links to the full PlanIt record and to planning application information from Leeds City Council, as illustrated in the code below.
...
Using data from new housing developments built prior to the 2011 Census, we have begun to develop a model to predict active travel levels to and from new homes.

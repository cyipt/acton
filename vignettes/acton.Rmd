...
As part of ACTON, the PlanIt API is being improved to make it easier to search for particular types of planning application. This will involve adding fields such as:

- app_type (for the different types of planning application e.g. Outline, Amendment)
...
For on-road walking and cycling routes, the quality of the street environment will be strongly affected by the amount of traffic on the roads. New homes often lie close to major roads and bypasses. This makes for unpleasant and potentially dangerous conditions. Busy roads can act as barriers which limit or discourage sustainable modes of travel.

We estimate the busyness of the roads which constitute routes from our case study sites to workplaces or other key destinations. By averaging the busyness of these route segments we can compute an index of average road busyness for the area surrounding each site.

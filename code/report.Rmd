...
PlanIt has an API which allows users to search for planning applications using a range of criteria, such as address, planning authority, bounding box, date or planning application identifier.
...
In assessing the suitability of a proposed site for residential development, one of the most important questions will be how accessible the site is. The provision of local services and community facilities is a key enabler of active travel. It's no use building top quality cycle and walking provision within the site if residents are presented with a 30 minute walk from their homes to reach the local shops. 
...
Show maps for all journeys to work and those under Go Dutch scenario.

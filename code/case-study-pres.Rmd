...
# What prevents people using the quiet routes?

```{r}
knitr::include_graphics("https://user-images.githubusercontent.com/52210872/76513464-3fde9580-644e-11ea-81b0-bb90b6a05db3.png")
```
